...
#R = Child-Pugh score
#AB = Diabetes
#AH = Max 90-day pre-op urine protein
#AQ = Coronary heart disease
#BO = Mean arterial pressure < 65 mmHg duration
#CT = Preoperative glucose
#DF = Postoperative neutrophils
#DP = Postoperative mean platelet volume measurement
#DS = Postoperative serum sodium
#DW = Preoperative antihypertensive medication
#EQ = Heparin during admission
#FJ = Intraoperative norepinephrine
